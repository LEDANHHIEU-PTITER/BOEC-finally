...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="Home.jsp">BOEC Admin</a>
    </div>
    <!-- /.navbar-header -->
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="#"><i class="fa fa-files-o fa-fw"></i> Nh?p hàng Pages<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="Electronic.jsp">Electronic Page</a>
                        </li>
                        <li>
                            <a href="Book.jsp">Book Page</a>
                        </li>
                        <li>
                            <a href="Clothes.jsp">Clothes Page</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
